...
//   // Update imageKey when profileImage changes to force re-render
//   useEffect(() => {
...
//         console.log("File read complete, updating profile image");
...
//   console.log("Current profile image:", profileData.profileImage);
...
//                           <Button
//                             size="sm"
//                             className="p-1 h-auto w-auto bg-editor-primary text-white rounded-full flex items-center justify-center shadow-md"
//                             onClick={handleAvatarButtonClick}
//                             type="button"
//                           >
//                             <Settings size={16} />
